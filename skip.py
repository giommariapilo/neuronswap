...
for name in names:
    if name not in skip_connections:
        ...
        print(torch.allclose(manually_swapped_output, swapped_outputs[name], rtol=1e-5, atol=1e-5))

print(pre_swapped_output[permutations['layer4.0.conv1']])
print('\n')
print(swapped_outputs['layer4.0.conv1'])